...
export default function FinanceServicesPage() {
    return (
        <div>
                ...
                <div className="flex flex-wrap md:flex-nowrap gap-y-3">
                    <div className="w-full md:w-2/5 flex flex-col justify-center">
                        ...
                        <ul className="flex gap-x-1 mt-3 px-3 flex-wrap">
                            <li>
                                <a href="#" className="underline opacity-90 hover:opacity-100">Pay in 4 interest-free* payments with Afterpay</a>
                            </li>
                            <li className="opacity-50"> | </li>
                            <li>
                                <a href="#" className="underline opacity-90 hover:opacity-100"> PayPlan by RBC<sup>TM</sup></a>
                            </li>
                            <li className="opacity-50"> | </li>
                            <li>
                    ...
                    <div className="w-full md:w-3/5 flex items-center justify-center">
                        <img
                            src="/images/FinanceServices/services.jpg"
            ...
            {/* 2nd div */}
            <section className="flex flex-col md:flex-row bg-gray-100 my-12">
                <div className="w-full md:w-[70%]">
                    <img
                        src="/images/FinanceServices/a-man-tossing-a-plush-toy-to-a-young-child.jpg"
                ...
                <div className="w-full md:w-[30%] flex flex-col justify-center p-6 md:p-12">
                    ...
                    <a
                        href=""
                        className="inline-block bg-black text-white font-bold py-2 px-6 rounded-full mt-6 w-[260px]"
                    >
            ...
            {/* 3rd section */}
            <section className="flex flex-col md:flex-row-reverse bg-gray-100 my-12">

                <div className="w-full md:w-[70%]">
                    <img
                        src="/images/FinanceServices/a-couple-inside-an-store.jpg"
                ...
                <div className="w-full md:w-[30%] flex flex-col justify-center p-6 md:p-12 bg-gray-100">
                    ...
                    <a
                        href="/images/FinanceServices/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-block bg-black text-white font-bold py-2 px-6 rounded-full mt-6 w-[130px]"
                    >
                        Apply now
                    </a>
                </div>
            ...
            <div className="flex flex-col lg:flex-row lg:gap-6">
                ...
                <div className="flex flex-col justify-center lg:col-span-1">
                    <div className="flex justify-center mb-6">
                        <img src="/images/FinanceServices/in-store-payment-options.jpg" alt="In store payment options" className="max-w-full h-auto" />
                    </div>
                ...
                <div className="flex flex-col justify-center lg:col-span-1 lg:mb-20">
                    <div className="flex justify-center mb-6">
                        <img src="/images/FinanceServices/online-payment-options.jpg" alt="Online payment options" className="max-w-full h-auto" />
                    </div>
