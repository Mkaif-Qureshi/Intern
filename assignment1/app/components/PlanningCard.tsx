    ...
    return (
        <div className="m-10">
            ...
            <div>
                ...
                <button className="rounded-full bg-black text-white px-10 text-wrap w-200 text-md text-bold my-3 py-2 max-h-[100px]">{content.button}</button>
            </div>
                ...
                <ul>
                    {
                        content.links.map((link, idx) => (
                            <li key={idx} className="ml-4 my-2 opacity-70 text-[15px] underline hover:opacity-100 cursor-pointer">
                                {link}
                            </li>
                        ))
                    }
